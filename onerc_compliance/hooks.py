...
permission_query_conditions = {
	...
	"Pension Compliance Form": "onerc_compliance.permissions.pension_form_query_conditions",
}

has_permission = {
	"Compliance Submission": "onerc_compliance.permissions.has_submission_permission",
	"Pension Compliance Form": "onerc_compliance.permissions.has_scheme_doc_permission",
}
